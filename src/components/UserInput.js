import { StyledUserInput } from "./styled/UserInput.styled"
    ...
    <StyledUserInput >
        <form>
            ...
            <div className="tip-amt">
                <label htmlFor="tipAmt">Select Tip %</label>
                
                <div className="tip-options">

                  <input type="radio" id="amt5" name="tip" value="5" />
                  <label htmlFor="amt5">5%</label>
                  
                  <input type="radio" id="amt10" name="tip" value="10" />
                  <label htmlFor="amt10">10%</label>

                  <input type="radio" id="amt15" name="tip" value="15" />
                  <label htmlFor="amt15">15%</label>

                  <input type="radio" id="amt25" name="tip" value="25" />
                  <label htmlFor="amt25">25%</label>

                  <input type="radio" id="amt50" name="tip" value="50" />
                  <label htmlFor="amt50">50%</label>

                  <input type="text" id="amtCustom" name="tip" placeholder="Custom" />
                
                </div>
                
            </div>
                
            <div className="num-ppl">
                <label htmlFor="num-ppl">Number of People</label>
